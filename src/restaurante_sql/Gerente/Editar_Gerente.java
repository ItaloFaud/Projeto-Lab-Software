 ...
 * @author Hoope
 */
public class Editar_Gerente extends javax.swing.JFrame {

    /**
     * Creates new form Editar_Produto
     */
    public Editar_Gerente(int id) {
        initComponents();
         setSize(690,400);
    ...
    private void initComponents() {
        ...
        jButton1.setText("Editar Gerente ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Editar_Gerente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Editar_Gerente().setVisible(true);
            }
        });
    }
