 ...
 * @author Hoope
 */
public class Ver_Edi_Produto extends javax.swing.JFrame {

    /**
     * Creates new form Visualizar_Produto
     */
    public Ver_Edi_Produto() {
        initComponents();
        setSize(690,400);
...
//        nf.setMinimumFractionDigits(2);
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Editar Produtos");
        ...
        jTable4.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Nome", "Porcao", "Categoria", "Preço U", "Estoque"
            }
        ));
    ...
    private void jTable4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable4MouseClicked
        ...
        p.setId((int) jTable4.getValueAt(linha, 0));
        p.setNome((String) jTable4.getValueAt(linha, 1));
        p.setPorcao((String) jTable4.getValueAt(linha, 2));
        p.setCategoria((String) jTable4.getValueAt(linha, 3));
        p.setValor((String) jTable4.getValueAt(linha, 4));
        p.setEstoque((String) jTable4.getValueAt(linha, 5));

        int confirm = JOptionPane.showConfirmDialog(null,"Deseja realmente editar este produto","Restaurante",JOptionPane.WARNING_MESSAGE);
        if (confirm == JOptionPane.YES_OPTION) {
            
            new Editar_Produto(p).setVisible(true);
            dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ver_Edi_Produto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
