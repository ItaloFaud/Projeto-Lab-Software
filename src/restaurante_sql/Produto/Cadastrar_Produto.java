...
public class Cadastrar_Produto extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        JtfProduto.setFont(new java.awt.Font("Tw Cen MT Condensed", 0, 18)); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (JtfProduto.getText() != "" && JtfValor.getText() != "" && JtfPorcao.getText() != "" &&
               JtfEstoque.getText() != "" && (String) JcbCategoria.getSelectedItem() != "") {
            pro.setCategoria((String) JcbCategoria.getSelectedItem());
            pro.setNome(JtfProduto.getText());
            pro.setValor(JtfValor.getText());
            pro.setPorcao(JtfPorcao.getText());
            pro.setEstoque(JtfEstoque.getText());
            
            JOptionPane.showMessageDialog(null,sql.Cadastro(pro),"Restaurante",JOptionPane.INFORMATION_MESSAGE);
