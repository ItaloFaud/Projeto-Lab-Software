 ...
 * @author Hoope
 */
public class Excluir_Garcom extends javax.swing.JFrame {

    /**
     * Creates new form Visualizar_Produto
     */
    public Excluir_Garcom() {
        initComponents();
        setSize(690,400);
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Excluir Garçom");
    ...
    private void jTable5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable5MouseClicked
        ...
        int confirm = JOptionPane.showConfirmDialog(null,"Deseja realmente excluir este garçom?","Restaurante",JOptionPane.WARNING_MESSAGE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Excluir_Garcom.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
