 ...
 * @author Hoope
 */
public class Visualizar_Garcom extends javax.swing.JFrame {

    /**
     * Creates new form Visualizar_Produto
     */
    public Visualizar_Garcom() {
        initComponents();
         setSize(690,400);
...
//        System.out.println("R$:"+nf.format(total));
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Visualizar Garçom");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Visualizar_Garcom.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
