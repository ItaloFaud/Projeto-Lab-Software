...
public class Adicionar_Pedido extends javax.swing.JFrame {
     ...
     */
    public Adicionar_Pedido(Usuario u) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jButton18.setFont(new java.awt.Font("Tw Cen MT Condensed", 0, 18)); // NOI18N
        jButton18.setForeground(new java.awt.Color(255, 102, 0));
        jButton18.setText("Tela Inicial");
    ...
    private void TabelaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TabelaMouseClicked
        ...
        int idconta = (int) Tabela.getValueAt(linha, 0);
        ...
        int c = JOptionPane.showConfirmDialog(null,"Deseja realmente adicionar um pedido a esta conta?","Restaurante",JOptionPane.INFORMATION_MESSAGE);
        if(c == JOptionPane.YES_OPTION){
            new Produto_Conta(this.u,idconta,idmesa,total).setVisible(true);
            dispose();
        }
